...
<figure class="case-figure">
  <AlphaVideo src="aim-animated" alt="AIM dashboard on two laptops — Plotly-based medical analytics visualizations, main view alongside trend exploration." width={1440} height={568} />
