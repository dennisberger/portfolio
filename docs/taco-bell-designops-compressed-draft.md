# Taco Bell Design Operations Compressed Draft
...
- **33%** — Research team expansion in January 2026
- **60+** — Components now supported in the design system
- **Two enterprise-wide firsts** — Figma Enterprise migration and AI-assisted design system governance pilot
- **Slack -> Jira** — Intake transformation and planning discipline
...
When I joined Taco Bell as its first Design Operations Lead, the company was beginning the shift from an agency-led design model to an in-house function it could own and scale. Design work was happening, but the operating infrastructure behind it was weak: requests came through Slack, planning was inconsistent, tools were fragmented, documentation lived in the wrong places, research did not exist as a capability, and there was no true design system foundation.
...
### 1. Replaced ad hoc requests with governed intake and planning
...
### 2. Built enterprise-grade design infrastructure
...
### 3. Made research a core product capability
...
### 4. Enabled a scalable design system and content workflow
...
I also identified content strategy as another missing capability. Designers were writing product copy themselves, which diluted focus and created quality issues. I advocated for a dedicated Content Strategy Lead, a role that now serves as a translation layer across brand, legal, and product language and has made the design team more efficient. Alongside this work, I also co-manage Taco Bell's relationship with Applause, an external accessibility validation partner, with the Director of Engineering.
...
- Scaled formal studies from 0 in 2023 to 22 in 2024 and 64 in 2025
